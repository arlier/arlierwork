...
\item  the file size\footnote{the total additional disk space requirement for 20k, so is less than 2T, this not a problem} decrease about 20\% after transform\footnote{about 50MB for one PMT of one light intensity}.
