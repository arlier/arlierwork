...
\item easy to manage (create, modify and update).
\end{enumerate}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{prliminary structure}
each PMT have one root file named in "SN_rawdata.root"
In the specific root file, we several trees and a auxilary data class:
