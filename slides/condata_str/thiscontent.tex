...
\begin{figure}
\centering
\includegraphics[width=0.78\textwidth]{figures/zr01.png} % 单图
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}
\centering
\includegraphics[width=0.78\textwidth]{figures/zr02.png} % 单图
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{update of container test results}
...
\begin{figure}
\centering
\includegraphics[width=0.78\textwidth]{figures/zr03.png} % 单图
\end{figure}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Summary}
