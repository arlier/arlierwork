...
\begin{figure}
\centering
\includegraphics[width=1.049\textwidth]{figure/EA1500_avewave.png} % 单图
\end{figure}
\end{column}
\end{columns}
\end{frame}
...
\begin{figure}
\centering
\includegraphics[width=1.049\textwidth]{figure/EA4149_avewave.png} % 单图
\end{figure}
\end{column}
\end{columns}
\end{frame}
...
%	\item  prilimary analysis show consistant results with the previous results;
