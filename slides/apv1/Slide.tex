...
\author[Yu Chen&& Rong Zhao ]{Email：zhaor25@mail2.sysu.edu.cn \and  } % \\ 专业：统计学 \\ 方向：数据分析与统计计算
...
%0. current state and stratages for AP test ,file size
%1.two sections: HAM and MCP
%2.2D hist;time interval , rise time position distribution
%3.DCR spectrum,DCR reduction
%4.consistant with different light intensity?
%5.details about the AP analysis.
% \end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}
\centering
\includegraphics[width=1.049\textwidth]{figure/EA0863_avewave.png} % 单图
\end{figure}
\end{column}
\end{columns}
\end{frame}
...
%%	\begin{equation}
%%		S_{idel}=P(n;\mu)\otimes G_{n}(x)=\sum_{n=0}^{\infty}\frac{\mu^{n}e^{-\mu}}{n!}\frac{1}{\sigma_{1}\sqrt{2\pi n}}exp(-\frac{(x-nQ_{1})^2}{2n\sigma_{1}^{2}})
%
%%	\end{equation}
...
%\begin{figure}[!h]
%\centering
%\includegraphics[width=.9\textwidth]{figure/hamfit.png} % 单图
%%\label{fig:wave2d}
...
%\begin{figure}[!h]
%\centering
%\includegraphics[width=.9\textwidth]{figure/mcpfit.png} % 单图
%%\label{fig:wave2d}
%\caption{MCP PMT}
%\end{figure}
%\end{column}
...
%\begin{figure}
%\centering
%\includegraphics[width=\textwidth]{figure/mcpfit.png} % 单图
...
%\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\begin{frame}{"cross-talk" coefficient}
%If one photon was magnified with two or times of the normal gain, the output signal can not be distinguished with the two photons event; this is really a bad news to PMT. 
%\vspace{.5cm}
%\hrule{\textwidth}
%\vspace{.5cm}
%	we define a parameter $\delta$ to describe the proportion of "cross-talk" signal as:
%\begin{equation}
%	\begin{split}
%		\delta&=\frac{\alpha}{1+\alpha}\\
%		&=\frac{2\times P_{2}+3\times P_{3}}{1+2\times P_{2}+3\times P_{3}}
%	\end{split}
%\end{equation}
%	where $\alpha=2\times P_{2}+3\times P_{3}$ is the total number of unreasonable events.
%\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\begin{frame}{distribution of  $\delta$}
%
%%\vspace{.5cm}
%%\hrule{\textwidth}
%%\vspace{.5cm}
...
%\begin{frame}{summary }
%\begin{itemize}
%\item the cross-talk signal proportion of MCP PMT is about....
