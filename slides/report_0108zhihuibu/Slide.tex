...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{figures/wavealign.png} % 单图
%\label{fig:wave2d}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{figures/bsl.png} % 单图
%\label{fig:wave2d}
\caption{波形投影}
\end{figure}
\end{column}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{figures/spe.png} % 单图
%\label{fig:wave2d}
\caption{电荷谱}
\end{figure}
\end{column}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{figures/specon.png} % 单图
\caption{平均值滤波之后的电荷谱}
\end{figure}
\end{column}
\end{columns}
