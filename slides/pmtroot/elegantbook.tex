...
\chapter{about the PMT testing raw data in root file}
\section{contents of root file }
...
If you are interested in the testing data of one specific PMT, you just need to process a root file which contains all testing raw data.
%\begin{itemize}
%	\item login to the PMT testing server 'login.pmt.ihep.ac.cn'  
...
\section{structure of the root file}
For each PMT test we have two sets of data, one with light intensity about 0.1pe and another about 1pe. Each test has about 24k waveforms recorded, and every waveform consists of 521 voltage values with unit mV. 
...
\section{how to access one ROOT file}
sever domain:
data directory:
