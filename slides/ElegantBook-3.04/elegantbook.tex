...
\section{计算电荷积分}
数据采集ADC的阻抗是50$\Omega$，我们用波形的面积($\int UT$) 除以电阻可以得到每一个信号的电荷量大小。实验中我们看到的信号来自于$\mu$子在闪烁体中沉积能量产生的发光，我们简单假设每个$mu$子事件平均产生光子数为5000个，系统总的的探测效率是10\%，那么我们预期看到的PMT信号就是$5000\times 10\%=500$个电子被放大之后的结果。
