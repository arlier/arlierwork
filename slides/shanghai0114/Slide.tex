...
\title{Performance of 20inch PMTs Based on the Container Testing Data}
%\subtitle{奖助金申请答辩}
...
\begin{frame}{PMT testingi data analysis}
...
\begin{figure}
\centering
\includegraphics[width=0.94\textwidth]{figures/program.pdf} % 单图
\caption{108}
\end{figure}
...
%\end{frame}
\section{Typical waveform and charge spectrum}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\begin{frame}{抽屉刻度方法}
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Amplitude spectrum of PMT(@$gain=10^7\&\&\mu\simeq 1.3$)}
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Aligned waveforms of PMT(@$gain=10^7\&\&\mu\simeq 1.3$)}
...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{Average waveform of PMT (@$gain=10^7\&\&\mu\simeq 1.3$)}
...
%\end{columns}
%\end{frame}
\section{statistical results of paramaters}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{$PDE$的计算}
