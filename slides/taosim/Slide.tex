...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}{ current geometry set-up}

\begin{figure}
\centering
	\includegraphics[width=0.77\textwidth]{currentfig/geofinished.png}
\caption{geometry of detector}
\end{figure}
...
\begin{frame}{optical simulation part}
	...
	\end{itemize}
	wave length range:350nm ,650nm,step 1nm.
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{currentfig/allplot.eps} % 单图
\caption{simulation results}
\end{figure}
\end{column}
\begin{column}{.4\textwidth}
	suppose the relectivity, refractive index and attenuation length to be constants for different wavelength.
%	\vspace{.3cm}
	\rule{\textwidth}{.61mm}
The main sensitive wavelength region is about 400nm-550nm.
\end{column}
\end{columns}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
