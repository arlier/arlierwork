...
\begin{frame}{photon response characters of MCP PMT }
	...
	we  can see clearly signals with charge more than 1p.e. If we suppose all the dark counts is caused by single thermal electron, then those fake multi-p.e events is caused by the magnification of MCP. 
\begin{columns}
\begin{column}{.485\textwidth}
\begin{figure}
\centering
