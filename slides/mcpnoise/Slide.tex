...
From the JUNO PMT testing data, we found thay when illumiated with single p.e phtons[$\mu=0.1$],MCP PMT will, typicaly ,output more multi-pe signals than dynode PMT. 
