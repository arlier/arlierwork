...
\title{Noise Spectrum and Photon Response of MCP-PMT}
...
\begin{frame}{01pe}
the "long tail" of charge spectrum,unexpected "big signals" .the MCP manification factor is not so stable.
\begin{columns}
