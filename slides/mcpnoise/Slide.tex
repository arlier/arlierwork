...
\begin{frame}{photon response characters of MCP PMT @$\mu\simeq 0.1$ }
	case 4: $\mu\simeq 1$\\
	When the light intensity increase to $\mu\simeq 1$ we can see a continuous "long tail " with charge >10p.e; this is a clear clue that MCP will imagnify little part of electrons  with abnornal large gain. 
\begin{columns}
\begin{column}{.495\textwidth}
\begin{figure}
\centering
